...
Open Visualisation Environment (OVE) is an open-source software stack, designed to be used in large high resolution display (LHRD) environments like the [Imperial College](https://www.imperial.ac.uk) [Data Science Institute's](https://www.imperial.ac.uk/data-science/) [Data Observatory](https://www.imperial.ac.uk/data-science/facilities/data-observatory/).
